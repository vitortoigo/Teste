<div class="flex items-center h-20 px-6 justify-between border-b flex justify-center px-4 text-gray-800 bg-white dark:text-white dark:bg-gray-800 relative z-50">
    <div class="h-8">
        <img src="https://gustui.s3.amazonaws.com/Gust+Logo+White.png" class="h-full" />
    </div>
    <div class="flex-1 ml-10 items-center hidden lg:flex">
        <a href="#" class="no-underline px-2 mr-3 text-gray-200 font-medium hover:text-blue-400">Home</a><a href="#" class="no-underline px-2 mr-3 font-medium hover:text-blue-400">Dogs</a><a href="#" class="no-underline px-2 mr-3 text-gray-200 font-medium hover:text-blue-400">Bones</a><a href="#" class="no-underline px-2 mr-3 text-gray-200 font-medium hover:text-blue-400">Settings</a>
    </div>
    <div class="items-center hidden lg:flex">
        <div class="inline-block rounded-sm font-medium border border-solid cursor-pointer text-center text-sm py-2 px-4 text-white bg-green-400 border-green-400 hover:bg-green-600 hover:border-green-600" type="">
            Add Food
        </div>
        ...
        </svg><svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bell" class="svg-inline--fa fa-bell fa-w-14 ml-6 text-2xl cursor-pointer" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
    ...
    <div class="hidden bg-blue-800 absolute top-full left-0 flex-col w-full pb-8 lg:hidden">
        <div class="flex-1 flex flex-col items-center text-xl">
            <a href="#" class="no-underline px-2 my-2 text-gray-200 font-medium hover:text-blue-400">Home</a><a href="#" class="no-underline px-2 my-2 font-medium hover:text-blue-400">Dogs</a><a href="#" class="no-underline px-2 my-2 text-gray-200 font-medium hover:text-blue-400">Bones</a><a href="#" class="no-underline px-2 my-2 text-gray-200 font-medium hover:text-blue-400">Settings</a>
            <div class="my-2 inline-block rounded-sm font-medium border border-solid cursor-pointer text-center text-sm py-2 px-4 text-white bg-green-400 border-green-400 hover:bg-green-600 hover:border-green-600" type="">
                Add Food
            </div>
